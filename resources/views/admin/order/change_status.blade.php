...
@section('content')
    ...
    @include('admin.partials.header', [ 'key' => 'Trang duyệt', 'name' => 'đơn hàng'])
    <!-- Main content -->
        <div class="content">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-md-12">
                        @if(session()->has('message_confirm_order'))
                            <p style="color: green">{{ session()->get('message_confirm_order') }}</p>
                        @endif
                    ...
                    <div class="col-md-12">
                        ...
                        <form action="{{ route('orders.send_mail_confirm', ['id' => $order->id]) }}" method="post">
                            @csrf
