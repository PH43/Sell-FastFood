                            ...
                            <div style="display: flex;   ">
                                ...
                                <div class="form-group" style="width: 170px; margin-left: 10px; margin-right: 10px">
                                    ...
                                    <select class="form-control" name="rating_value">
                                        ...
                                        <option value="5">Ổn</option>
                                        <option value="10">Ngon</option>
                                    </select>
                                </div>
                                ...
                                <div class="form-group" style="padding-top: 32px;margin-left: 20px">
                                    <p>Tệ : <img style="height: 30px;height: 30px"
                                                 src="{{ asset('img/unlike.png') }}" alt=""></p>
                                </div>
                                <div class="form-group" style="padding-top: 32px;margin-left: 20px">
                                    <p>Ổn : <img style="height: 30px;height: 30px"
                                                 src="{{ asset('img/neutral.png') }}" alt=""></p>
                                </div>
                                <div class="form-group" style="padding-top: 32px;margin-left: 20px">
                                    <p>Ngon : <img style="height: 30px;height: 30px"
                                                   src="{{ asset('img/like.png') }}" alt=""></p>
                                </div>
                            </div>
                        ...
                        <table class="table">
                            ...
                            @foreach($comments as $comment)
                                <tr>
                                    ...
                                    <td>{{ $comment->name }}</td>
                                    <td><img src="{{ $comment->feature_image_path }}" style="width: 100px; height: 80px"
                                             alt=""></td>
...
{{--        <script src="{{ asset('js/search_comment.js') }}"></script>--}}
